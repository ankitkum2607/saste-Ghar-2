...
export function PropertyQuiz({ className }: { className?: string }) {
        ...
        <AnimatePresence mode="wait">
          {!done ? (
            ...
            >
              ...
              <h3 className="mt-3 font-heading text-[28px] font-semibold leading-tight text-primary sm:text-4xl">
              ...
              <div className="mx-auto max-w-2xl text-center">
                ...
                <h3 className="mt-3 font-heading text-[28px] font-semibold leading-tight text-primary sm:text-4xl">
                  {result && result.matches.length === 0
                    ...
                    : result?.exact
                    ? "Properties matched your selection"
